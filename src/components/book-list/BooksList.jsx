...
export default function BooksList() {
  ...
  useEffect(() => {
    if (books) setIsBooksLoading(false);
  }, [books]);
  ...
  return (
    <div
      className={clsx(
        "d-flex flex-column container x2-gap justify-content-start",
        classes[`booklist`]
      )}
    >
      <BooksFilter filter={filter} setFilter={setFilter} />
      <section
        className={clsx("d-flex flex-wrap justify-content-center x2-gap")}
      >
        {isBooksLoading ? (
          <Loader />
